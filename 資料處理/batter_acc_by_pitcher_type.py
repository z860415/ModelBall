...
for info in df_game.values.tolist():
    try:
        ...
        all = [info[1],info[2],info[3],h_pitcher_xFIP,demo_away[0],demo_away[1],demo_away[2],demo_away[3],demo_away[4],demo_away[5],
               demo_away[6],demo_away[7],demo_away[8],a_pitcher_xFIP,demo_home[0],demo_home[1],demo_home[2],demo_home[3],
               demo_home[4],demo_home[5],demo_home[6],demo_home[7],demo_home[8],info[25],info[24],info[26],info[29]]
        #info[25] = away_total
        #info[24] = home_total
        #info[26] = yard_wOBA
        #info[29] = umpire_K/BB
...
new_df = pd.DataFrame(demo2,columns=['date','time','machup','home_pitcher','away_batter1','away_batter2','away_batter3','away_batter4','away_batter5','away_batter6','away_batter7','away_batter8',

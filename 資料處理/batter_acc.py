...
#空值填補中位數
# woba = ['away_1_woba','away_2_woba','away_3_woba','away_4_woba','away_5_woba','away_6_woba','away_7_woba','away_8_woba','away_9_woba',
#         'home_1_woba','home_2_woba','home_3_woba','home_4_woba','home_5_woba','home_6_woba','home_7_woba','home_8_woba','home_9_woba']
# df = pd.read_csv('qqq.csv',na_values='')
# for i in woba:
#         q_50 = np.percentile(df[~df[i].isnull()][i], 50)
#         df.loc[df[i].isnull(),i] = q_50
#         print(q_50)
#         print(df)
#         df.to_csv('qqq.csv', encoding='utf8', index=False)
